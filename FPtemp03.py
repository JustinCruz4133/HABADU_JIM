...
def update_inC_Q():
    global show_in_consul, show_in_queue, show_doc_name, show_doc_age, show_doc_symptoms
...
def ps_ds_qs():
    ...
    global dscreen, list_doc, list_doc_name, list_doc_age, list_doc_symptoms, list_doc_name01, list_doc_age01, list_doc_symptoms01
    ...
    list_doc_name = Listbox(dscreen, height=1, width=17, justify="center", font=("Sans Serif", 25, "bold"))
    list_doc_name.place(x=130, y=125)

    Label(dscreen, text="Age:", bd=0, font=("Sans Serif", 12, "bold")).place(x=40, y=215)
    list_doc_age = Listbox(dscreen, height=1, width=17, justify="center", font=("Sans Serif", 25, "bold"))
    list_doc_age.place(x=130, y=200)

    Label(dscreen, text="Symptoms:", bd=0, font=("Sans Serif", 12, "bold")).place(x=35, y=290)
    list_doc_symptoms = Listbox(dscreen, height=1, width=17, justify="center", font=("Sans Serif", 25, "bold"))
