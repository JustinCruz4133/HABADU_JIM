...
def ps_ds_qs():
    ...
    list_doc_age = Listbox(dscreen, height=1, state=DISABLED, width=17, justify="center", font=("Sans Serif", 25, "bold"))
    ...
    in_consul = Entry(wscreen, justify="center", state='readonly', textvariable=in_consul_var)
    in_consul.pack()
